...
def main():
	...
	generator = train_srresnet(generator, dataloader, device, experiment,model_name, lr=1e-5, total_steps=srresnet_steps, display_step=100)
	...
	generator,discriminator = train_srgan(generator, discriminator, dataloader, device, experiment,model_name, lr=1e-5, total_steps=gan_steps, display_step=100,lambda_gp=10)
